...
def evaluate(pset):
    ...
    run_and_plot(solution=solution, final_time=final_time, plot_times=plot_times, file_path=file_path)
    return pset
...
def run_sweep():
    ...
    df = ps.run(evaluate, params, poolsize=4, backup_calc_dir=False, backup_script=__file__,simulate=False)
